    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <li><code>Expedient43-v1.0.apk</code> ({t.download_center.apk_version_label})</li>
        ...
        >
          ...
          >
            <i className="fa-solid fa-list-check" /> {t.download_center.apk_install_guide_title}
          </h2>
