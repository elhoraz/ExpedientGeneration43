...
export const ASATIDZ_ITEMS: AsatidzItem[] = [
  ...
  },
  {
    ...
    category: "pimpinan",
    subject: "Dirasah Islamiyah & Kurikulum KMI",
    photoUrl: "/uploads/asatidz/ust-saroni.webp",
    quote: "Dimanapun, kapanpun, menjadi apapun, jangan pernah meninggalkan sholat wajib!",
    isRahimahullah: false,
    collageUrl: "/uploads/asatidz/pesan-ust-saroni.webp",
    notes: "KMI Directure of Arrisalah Islamic International College",
    wasiat: [
      "Pesan Mutiara Direktur KMI (Arrisalah, 5 Desember 2024):",
      "بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ",
      "Dimanapun, kapanpun, menjadi apapun, jangan pernah meninggalkan sholat wajib!",
      "— Al-Ustadz Sa'roni, Lc. (KMI Directure of Arrisalah Islamic International College)"
    ],
  },
  {
    id: "pimpinan_shoiman",
